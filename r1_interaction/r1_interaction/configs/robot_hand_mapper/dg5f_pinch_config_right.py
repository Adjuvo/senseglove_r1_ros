...
DG5FPinchConfigRight = PinchConfig(
    name="DG5FPinchConfigRight",
    # Robot Hand Pinch Targets (from percentage bent values)
    # Format: Finger_index: [thumb_abduction, thumb_flexion, finger_flexion]
    robot_pinch_targets={
        1: [6900.000,  3000.000, 4200.000],  # Pinch Index
        2: [8000.000,  4000.000, 4550.000],  # Pinch Middle
        3: [9700.000,  4450.000, 4850.000],  # Pinch Ring
        4: [10000.000, 5800.000, 6800.000],  # Pinch Pinky
    },
